...
if __name__ == '__main__':
    ...
    experimental_condi = []
    experimental_condi.append('Observe Relaxation : ED : XY-Heisenberg model')
    experimental_condi.append('Hamiltonian : - J ( Sx Sx + V Sy Sy) - h Sz')
    ...
    if(relaxation):
        ...
        hamiltonian_thermalize.add_H_2body(Sy, Sy, coef=-J_int*V,position=[tagged-1,tagged])
    hamiltonian_thermalize.add_H_1body(Sz, coef=-h)
    hamiltonian_thermalize.add_H_2body(Sx, Sx, coef=-J)
    hamiltonian_thermalize.add_H_2body(Sy, Sy, coef=-J*V)
    ...
    hamiltonian_total.add_H_2body(Sy, Sy, coef=-J*V)
    hamiltonian_total.add_H_2body(Sx, Sx, coef=-J_int,position=[tagged-1,tagged])
    hamiltonian_total.add_H_2body(Sy, Sy, coef=-J_int*V,position=[tagged-1,tagged])
    if(engine):
        if(not discrete):
